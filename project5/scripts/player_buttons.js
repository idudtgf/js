var names = document.getElementById("radio-title")
class Player{
    constructor(){
        ...
        this.audios =[];
        this.audios[0] = "./musics/music.mp3";
        this.audios[1] = "./musics/music1.mp3";
        this.audios[2] = "./musics/music2.mp3";
    
        this.names = [];
        this.names[0] = "Stackin it-Gunna";
        this.names[1] = "Wanna flow-Gunna";
        this.names[2] = "Baby Brink-Gunna";
        this.numberAudio =0;
